...
export default function Forms({ navigation }){
    ...
    const handleSubmit = async (values) => {
        try {
            const response = await axios.post('http://192.168.19.231:9000/guardar-datos', values);
    ...
    return(
        <View style={estilos.container1}>
            <View style={estilos.container}>
                <Formik
                    initialValues={{ nombreI: '', edadI: '', fechaN: '' , selFut: '', selChar: ''}}
